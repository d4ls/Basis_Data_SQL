...
|  DECIMAL (M,D)  |  Ukuran M byte. Bilangan pecahan, misalnya DECIMAL(5,2 dapat digunakan untuk menyimpan bilangan 
                     -99,99 s/d 99,99                                                                                   |
|  NUMERIC (M,D)  |  Ukuran M byte. Sinonim dari DECIMAL, misalnya NUMERIC(5,2) dapat digunakan untuk menyimpan 
...
1.  ***Data Definision Language*** ***(DDL)***
    ...
    3.  Alter : Digunakan untuk melakukan perubahan struktur tabel yang
        ...
        ![](images/Screenshot 2024-12-07 191040.png){width="336"}
...
2.  ***Data Manipulation Language*** ***(DML)***
    ...
    3.  Delete : Digunakan untuk penghapusan data pada Tabel Database
        ...
        ![](images/Screenshot 2024-12-07 193136.png){width="340"}
...
3.  Data Control Languange (DCL)
    ...
    4.  Rollback : Membatalkan penyimpanan Database
        ...
        ![](images/Screenshot 2024-12-07 193227.png){width="339"}
:::
...
![](images/Screenshot 2024-12-05 154344.png)
...
![](images/Screenshot 2024-12-05 165731.png)
...
![](images/Screenshot 2024-12-05 172035.png)
...
![](images/Screenshot 2024-12-06 135136.png)
:::
...
1.  Satu ke Satu (One to One), yang berarti satu entitas A berhubungan
    ...
    ![](images/Screenshot 2024-12-06 143801.png)
...
2.  Satu ke Banyak (One to Many), yang berarti satu entitas A dapat
    ...
    ![](images/Screenshot 2024-12-06 144656.png)
...
3.  Banyak ke Satu (Many to One), yang berarti satu entitas A
    ...
    ![](images/Screenshot 2024-12-06 144123.png)
...
4.  Banyak ke Banyak (Many to Many), yang berarti satu entitas A dapat
    ...
    ![](images/Screenshot 2024-12-06 144206.png)
:::
